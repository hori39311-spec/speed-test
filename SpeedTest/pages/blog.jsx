    ...
    <div className="min-h-screen w-full bg-black text-gray-100 relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 py-16">
        <header className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-400 text-lg">Latest insights & articles</p>
        </header>

        {/* Feature post card */}
        <article className="rounded-2xl border border-gray-800 bg-black/60 backdrop-blur p-6 shadow-lg">
          <h2 className="text-2xl font-semibold mb-2 text-white">Welcome to our Blog</h2>
          <p className="text-gray-300 text-lg leading-relaxed">
            Here we share tips, deep dives, and guides on internet speed, VPN performance, Wi‑Fi optimization and more.
          </p>
          <div className="mt-4 text-sm text-gray-400">Coming soon: real benchmarks, provider comparisons, and optimization checklists.</div>
        </article>

        {/* Placeholder list */}
        <div className="grid gap-4 mt-6">
          <article className="rounded-2xl border border-gray-800 bg-black/50 p-5">
            <h3 className="text-lg font-semibold text-white">How to read a speed test result</h3>
            <p className="text-gray-300 mt-1">Understanding download, upload, latency and jitter in practice.</p>
          </article>
          <article className="rounded-2xl border border-gray-800 bg-black/50 p-5">
            <h3 className="text-lg font-semibold text-white">Wi‑Fi vs Ethernet: when it matters</h3>
            <p className="text-gray-300 mt-1">What you actually gain by plugging in.</p>
          </article>
        </div>
